...
def E0(airtemp = scipy.array([]),\
    ...
    Parameters:
        ...
        - alpha: albedo [-] set at 0.06 for open water by default.
        - Z: (array of) site elevation [m a.s.l.], default is 0 m a.s.l.
    ...
    alpha set by default at 0.06 for open water.
    ...
    690-702. Following Penman (1948, 1956).
